...
public class KafkaEhrConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactoryRequestItem() {
        Map<String, Object> configProps = getConfigProps("RequestDataConsumer");
    ...
    @Bean
    public KafkaListenerContainerFactory<ConcurrentMessageListenerContainer<String, String>> kafkaListenerContainerFactoryRequestItem() {
        ConcurrentKafkaListenerContainerFactory<String, String> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(consumerFactoryRequestItem());
